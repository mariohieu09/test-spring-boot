...
public class AuthController {
    ...
    @Parameter(name = "userRequest", description = "The request body containing user information for registration", required = true)
    ...
    @ApiResponse(responseCode = "400", description = "Bad request")
    @ApiResponse(responseCode = "500", description = "Internal server error")
    @Parameter(name = "authenticationRequest", description = "The request body containing authentication credentials for login", required = true)
    @Parameter(name = "language", description = "The language for response messages (optional, default is the system default language)")
    @PostMapping("/login")
